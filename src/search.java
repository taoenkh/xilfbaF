        ...
        try
           {
	          ...
	          director1 = request.getParameter("director");
	          star = request.getParameter("name");

	          
              out.println("<a href = 'main?title=" +title1+"&year="+year1+"&director="+director1+"&name="+star+"&param=titled&limit="+limit+"'>Sort by title (Descending order)</a>");
              out.println("<a href = 'main?title=" +title1+"&year="+year1+"&director="+director1+"&name="+star+"&param=titlea&limit="+limit+"'>Sort by title (Ascending order)</a>");
              out.println("<a href = 'main?title=" +title1+"&year="+year1+"&director="+director1+"&name="+star+"&param=yeard&limit="+limit+"'>Sort by year (Descending order)</a>");
              out.println("<a href = 'main?title=" +title1+"&year="+year1+"&director="+director1+"&name="+star+"&param=yeara&limit="+limit+"'>Sort by year (Ascending order)</a>");
              out.println("</div>");
              ...
              out.println("<a href = 'main?limit=5&title=" +title1+"&year="+year1+"&director="+director1+"&name="+star+"&param="+sorting+"'>5</a>");
              out.println("<a href = 'main?limit=10&title=" +title1+"&year="+year1+"&director="+director1+"&name="+star+"&param="+sorting+"'>10</a>");
              out.println("<a href = 'main?limit=15&title=" +title1+"&year="+year1+"&director="+director1+"&name="+star+"&param="+sorting+"'>15</a>");
              out.println("<a href = 'main?limit=20&title=" +title1+"&year="+year1+"&director="+director1+"&name="+star+"&param="+sorting+"'>20</a>");
              out.println("</div>");
	          ...
	          if (!year1.equals("")) {
	        	  othercondition+= "and n.year = "+year1 +" \n";
	        	  
	          }
	          if (!director1.equals("")) {
	        	  othercondition+= "and n.director like '%"+director1 +"%' \n";
	          }
	          if (! star.equals("")) {
	        	  
	        	  
	        	  othercondition += "and stars.name like '%"+ star + "%'\n";
	          }
            ...
            Connection dbcon = ds.getConnection();
              ...
              String query = "SELECT n.id,title, year, director,group_concat(distinct stars.name ),group_concat(distinct genres.name)\r\n" + 
                		"from (select* from movies where title like" +"'%"+ttle+"%'"+ ") as n,stars,stars_in_movies,genres_in_movies\r\n" + 
...
//              else {
              ...
              {		
                  ...
                  out.println("<a href = 'main?limit="+limit+"&title=" +title1+offsetp+"&year="+year1+"&director="+director1+"&name="+star+"&param="+sorting+"'>Prev</a>");
                  out.println("<a href = 'main?limit="+limit+"&title=" +title1+offsetn+"&year="+year1+"&director="+director1+"&name="+star+"&param="+sorting+"'>Next</a>");
                  out.println("</div>");
            	  }
              		flag = true;
